...
3.  **Local MPS Simulation**: Using the `matrix_product_state` backend with a Bond Dimensiotrailved the probability peaks that were previously buried under depth.
